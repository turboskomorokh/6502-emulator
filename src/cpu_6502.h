...
struct CPU_6502 {
 ...
 // Internal cycles: 5
 void RTS(uint32_t& Cycles, Memory& memory);
 // Internal cycles: 0
 void SBC(Byte M);
 void SEC(uint32_t& Cycles);
 void SED(uint32_t& Cycles);
 void SEI(uint32_t& Cycles);
 void STA(uint32_t& Cycles, Memory& memory, Word Address);
 void STX(uint32_t& Cycles, Memory& memory, Word Address);
 void STY(uint32_t& Cycles, Memory& memory, Word Address);
 void TAX(uint32_t& Cycles);
 void TAY(uint32_t& Cycles);
 void TSX(uint32_t& Cycles);
 void TXA(uint32_t& Cycles);
 void TXS(uint32_t& Cycles);
 void TYA(uint32_t& Cycles);
